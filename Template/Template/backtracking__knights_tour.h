...
#ifndef backtracking__knights_tour_h
#define backtracking__knights_tour_h
#include <stdio.h>
#define N 8
...
void printSolution(int sol[N][N]) {
    for (int x = 0; x < N; x++) {
        for (int y = 0; y < N; y++) printf(" %2d ", sol[x][y]);
        printf("\n");
    }
}
...
#endif /* backtracking__knights_tour_h */
