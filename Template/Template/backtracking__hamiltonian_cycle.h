//
//  backtracking__hamiltonian_cycle.h
//  Template
//
...
#ifndef backtracking__hamiltonian_cycle_h
#define backtracking__hamiltonian_cycle_h
#define V 5
...
#endif /* backtracking__hamiltonian_cycle_h */
